...
<html lang="en">
    ...
    <body>
        ...
        <section id="product1" class="section-p1">
            <div class="row">
                <form action="CategoryServlet" class="filter d-flex" style="width: 50%;" method="get">
        ...
        <section id="pagination" class="section-p1">
            <c:forEach var="i" begin="1" end="${totalPages}">
                <a <c:if test="${i == currentPage}">class="active bg-secondary"</c:if> href="ShopServlet?page=${i}">${i}</a>
            </c:forEach>
